...
Cause: Too few transcripts in the 70-96% quantile range Solution:
...
Cause: Mismatch between count matrix columns and annotation Solution:
...
Cause: Extreme proportions or low counts Solution:
